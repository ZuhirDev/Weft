...
return [
    ...
    | que se usan en la clase validadora. Algunas de estas reglas tienen varias
    | versiones, como las reglas de tamaño. Siéntete libre de modificar cada uno
    | de estos mensajes aquí según sea necesario.
    |
    */
    ...
    | Esto facilita especificar una línea de lenguaje específica para una regla
    | dada de un atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se usan para reemplazar nuestro marcador
    | de posición de atributo con algo más amigable, como "Dirección de Correo"
    | en lugar de "email". Esto nos ayuda a hacer nuestros mensajes más expresivos.
    |
    */
