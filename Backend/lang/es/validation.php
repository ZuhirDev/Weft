...
return [
    ...
    | utiliza la clase validadora. Algunas reglas tienen varias versiones
    | como las reglas de tamaño. Puedes modificar estos mensajes a tu gusto.
    |
    */
    ...
    | convención "atributo.regla" para nombrar las líneas. Esto facilita definir
    | mensajes personalizados específicos para una regla de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas son usadas para cambiar el nombre del placeholder
    | :attribute por algo más amigable para el usuario, como "Correo Electrónico"
    | en vez de "email". Esto ayuda a que los mensajes sean más claros.
    |
    */
