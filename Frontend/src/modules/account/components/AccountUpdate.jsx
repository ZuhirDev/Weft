    ...
    <Card className="w-full max-w-xl mx-auto border border-muted shadow-sm">
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-lg">Actualizar Cuenta</CardTitle>
        </div>
      </CardHeader>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <CardContent className="space-y-6 py-4">
          <div>
            ...
            />
            {errors.alias && (
              <p className="text-red-500 text-sm mt-1">{errors.alias.message}</p>
            )}
          </div>

          <div>
            <Label htmlFor="statusSwitch" className="mb-1 block">Estado de la cuenta</Label>
